  ...
  return (
    <div>
     <div className="flex flex-col lg:flex-row items-center max-w-6xl mx-auto py-10 px-5 gap-10">
      ...
      >
        <img
          src="https://caddcore.net/wp-content/uploads/2024/11/149528833_5341628802544327_2717259404816850657_n.jpg"
    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="md:w-2/3">
          <h1 className="text-base md:text-md leading-relaxed text-gray-800">
        ...
        <div className="md:w-1/4">
          <Image
            src="https://caddcore.net/wp-content/uploads/2024/11/pexels-thirdman-8482823-min-scaled.jpg"
            alt="About Image"
            width={500}
            height={500}

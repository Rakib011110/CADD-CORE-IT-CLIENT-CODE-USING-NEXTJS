...
export default function AboutStatsSection() {
  ...
  return (
    <div className="bg-black w-full mx-auto h-64 mb-10 text-white py-10 px-2">
      <div className="max-w-6xl h-44  mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
